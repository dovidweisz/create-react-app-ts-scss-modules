# `react-scripts-ts-scss-modules`

Create React apps (with Typescript and Sass - using css modules ) with no build configuration.
...
create-react-app my-app --scripts-version=@dovidweisz/react-scripts-ts-scss-modules
cd my-app/
npm start
```
